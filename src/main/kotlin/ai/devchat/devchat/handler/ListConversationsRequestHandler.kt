...
class ListConversationsRequestHandler(private val actionHandler: DevChatActionHandler) : ActionHandler {
    private var metadata: JSONObject? = null
    private var payload: JSONObject? = null
    override fun executeAction() {
        Log.info("Handling load conversations request")
        val callbackFunc = metadata!!.getString("callback")
        val topicHash = metadata!!.getString("topicHash")
        try {
            val conversations = actionHandler.devChat.logTopic(topicHash, null)
